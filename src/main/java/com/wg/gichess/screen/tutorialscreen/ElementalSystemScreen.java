...
public class ElementalSystemScreen extends FastScreen{
    public int target;
    public FastScreen lastScreen;


    public ElementalSystemScreen(boolean isFirst,int target,FastScreen lastScreen) {
        super(Component.literal("元素教学界面"), isFirst);
        this.target = target;
