...
public class AdvancedTechniquesScreen extends FastScreen {
    public int target;
    public FastScreen lastScreen;


    public AdvancedTechniquesScreen(boolean isFirst,int target,FastScreen lastScreen) {
        super(Component.literal("进阶教学界面"), isFirst);
        this.target = target;
