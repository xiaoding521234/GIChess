...
public class FundamentalsScreen extends FastScreen {
    public int target;
    public FastScreen lastScreen;


    public FundamentalsScreen(boolean isFirst,int target,FastScreen lastScreen) {
        super(Component.literal("新手教学界面"), isFirst);
        this.target = target;
