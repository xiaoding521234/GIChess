...
public class Lobby extends Movable {
    public int i =-1;

    public Lobby(boolean isFirst) {
        super("textures/map/"+ User.positionType.regionType.id +  "/" +User.positionType.materialID +".png",isFirst);
