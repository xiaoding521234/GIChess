...
import com.wg.gichess.screen.tutorialscreen.AdvancedTechniquesScreen;
import com.wg.gichess.screen.tutorialscreen.FundamentalsScreen;
import net.minecraft.client.Minecraft;

public class AdvancedTechniquesButton extends Movable {
    public int target;
    public int id=3;
    public FastScreen lastScreen;

    public AdvancedTechniquesButton( int x, int y,boolean isFirst,int target,FastScreen lastScreen) {
        super("textures/tutorialscreen/advancedtechniquesbutton.png", x, y,isFirst);
    ...
    public boolean click() {
        if (isMouseOn() && target != id){
            Minecraft.getInstance().setScreen(new AdvancedTechniquesScreen(false,id,lastScreen));
            return true;
        }
        return false;
    }
