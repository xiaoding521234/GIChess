...
public class ViewModeButton extends Movable {

    public ViewModeButton(int x, int y, boolean isFirst) {
        super("textures/battlelobbyscreen/viewmodebutton.png", x, y, isFirst);
        this.vY = 160;
